...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct  1 10:23:45 2021
...
rok=2020
dataset=netCDF4.Dataset('/data/oko/dusan/sentinel5P/no2/2020/post_data/no2_trop_grid.nc')
...
for s in (dataset.variables['times'][:]):
    dates = datetime(rok, 1, 1,10,32,12,742616)+ timedelta(seconds=s)
    datumy.append(dates)
